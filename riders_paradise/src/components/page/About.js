...
function About() {
  ...
  return (
    <div className="main-container" style={{ backgroundColor: '#0F1923', color: '#FF4655' }}>
      <link
        rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
      />
    <div>
      <div class="page-about shadow" style={{ backgroundColor: '#0F1923', color: '#FF4655', padding: '20px' }}>
        <div class="main-container shadow" style={{ backgroundColor: '#1E2B3A', borderRadius: '10px', marginBottom: '20px' }}>
          <MDBContainer>
            <br />
            <br />
            <MDBRow>
              <MDBCol sm={12} md={4}>
                <div class="container" style={{ textAlign: 'center' }}>
                  <img
                    src={imgallen}
                    alt="Allen"
                    style={{ width: "65%", borderRadius: "100%", border: '3px solid #FF4655' }}
                  />
                  <br />
                  <Link className="Link" to="https://www.linkedin.com/in/all3n-f3bi/" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-linkedin" style={{ fontSize: '24px' }} />
                  </Link>
                  <Link className="Link" to="https://github.com/all3n2601" style={{ color: '#FF4655', margin: '5px' }}>
              ...
              <MDBCol>
                <div class="container">
                  ...
                  <p className="p-about" style={{ color: '#FFFFFF' }}>Vellore Institute of Technology Amaravati</p>
                </div>

                <hr style={{ backgroundColor: '#FF4655' }}/>
                ...
                <MDBContainer>
                  <MDBRow>
                    ...
                    <MDBCol>
                      <p class="bio" style={{ color: '#FFFFFF' }}>
            ...
            <MDBRow>
              <MDBCol sm={12} md={4}>
                <div class="container" style={{ textAlign: 'center' }}>
                  ...
                  />
                  <br />
                  <Link className="Link" to="https://www.linkedin.com/in/rahul-palanivel-629464279/" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-linkedin" style={{ fontSize: '24px' }}/>
                  </Link>
                  <Link className="Link" to="https://github.com/rahulpalanivel" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-github" style={{ fontSize: '24px' }}/>
                  </Link>
                </div>
              </MDBCol>
            ...
            <MDBRow>
              <MDBCol sm={12} md={4}>
                <div class="container" style={{ textAlign: 'center' }}>
                  ...
                  />
                  <br />
                  <Link className="Link" to="https://www.linkedin.com/in/manigandan-n" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-linkedin" style={{ fontSize: '24px' }}/>
                  </Link>
                  <Link className="Link" to="https://github.com/manigandan-2003" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-github" style={{ fontSize: '24px' }}/>
                  </Link>
                </div>
              </MDBCol>
            ...
            <MDBRow>
              <MDBCol sm={12} md={4}>
                <div class="container" style={{ textAlign: 'center' }}>
                  ...
                  />
                  <br />
                  <Link className="Link" to="https://www.linkedin.com/in/sree-vishnu-v-910b69231/" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-linkedin" style={{ fontSize: '24px' }}/>
                  </Link>
                  <Link className="Link" to="https://github.com/Sreevishnu1924" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-github" style={{ fontSize: '24px' }}/>
                  </Link>
                </div>
              </MDBCol>
            ...
            <MDBRow>
              <MDBCol sm={12} md={4}>
                <div class="container" style={{ textAlign: 'center' }}>
                  ...
                  />
                  <br />
                  <Link className="Link" to="https://www.linkedin.com/in/varun-venkatesh-2015b3219?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-linkedin" style={{ fontSize: '24px' }}/>
                  </Link>
                  <Link className="Link" to="https://github.com/varunvenkat22" style={{ color: '#FF4655', margin: '5px' }}>
                    <i className="fa fa-github" style={{ fontSize: '24px' }}/>
                  </Link>
                </div>
              </MDBCol>
